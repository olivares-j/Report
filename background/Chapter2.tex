...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[height=5cm]{background/Figures/F13_Galli2017.pdf}
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.45\textwidth}
       \includegraphics[height=5cm]{background/Figures/Parallax_GaiaCol2017.pdf}
...
\begin{figure}[ht!]
    \centering
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[height=5cm]{background/Figures/F1_Converse2010.pdf}
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.45\textwidth}
       \includegraphics[height=5cm]{background/Figures/F8_Adams2001.pdf}
...
\begin{figure}[ht!]
    \centering
    \begin{subfigure}[t]{0.45\textwidth}
        \includegraphics[page=2,height=5cm]{background/Figures/CIs.pdf}
        \caption{}
        \label{}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\textwidth}
      \includegraphics[page=3,height=5cm]{background/Figures/CIs.pdf}
        \caption{}
        \label{} 
    \end{subfigure}
     \begin{subfigure}[t]{0.45\textwidth}
      \includegraphics[page=4,height=5cm]{background/Figures/CIs.pdf}
        \caption{}
        \label{} 
    \end{subfigure}
     \begin{subfigure}[t]{0.45\textwidth}
      \includegraphics[page=5,height=5cm]{background/Figures/CIs.pdf}
        \caption{}
        \label{} 
    \end{subfigure}
