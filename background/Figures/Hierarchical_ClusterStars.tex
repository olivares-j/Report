...
%############# NON-MEMBERS ##############################
\node[draw, fill = gray!20, label={[name = mu_nm_pm_lab,xshift=-10pt,yshift=2pt]below:$\boldsymbol{\mu}_{pm}^{nm}$}] (mu_nm_pm) [left = of x_i,xshift=-120pt,yshift=100pt] {$[2]$};

\node[draw, fill = gray!20, label={[name = sg_nm_pm_lab,xshift=-10pt,yshift=2pt]below:$\Sigma_{pm}^{nm}$}] (sg_nm_pm) [right = of mu_nm_pm,yshift=0pt] {$[2,2]$};
\node[draw, fill = gray!20, label={[name = pi_nm_pm_lab,xshift=-10pt,yshift=2pt]below:$\pi_{pm}^{nm}$}] (pi_nm_pm) [right = of sg_nm_pm,yshift=0pt] {$[M_{pm}]$};

\node[draw, fill = gray!20, label={[name = mu_nm_phot_lab,xshift=-10pt,yshift=2pt]below:$\boldsymbol{\mu}_{ph}^{nm}$}] (mu_nm_phot) [left = of x_i,xshift=-120pt,yshift=-60pt] {$[5]$};

\node[draw, fill = gray!20, label={[name = sg_nm_phot_lab,xshift=-10pt,yshift=2pt]below:$\Sigma_{ph}^{nm}$}] (sg_nm_phot) [right = of mu_nm_phot,yshift=0pt] {$[5,5]$};
\node[draw, fill = gray!20, label={[name = pi_nm_phot_lab,xshift=-10pt,yshift=2pt]below:$\pi_{ph}^{nm}$}] (pi_nm_phot) [right = of sg_nm_phot,yshift=0pt] {$[M_{ph}]$};

\begin{pgfonlayer}{background}
\node (rect) at (mu_nm_pm) [xshift = 30pt, yshift = -4pt, draw, rounded corners, thick, minimum width=110pt, 
minimum height=50pt, line width=1pt, fill=gray!20, fill opacity=0.5] (rect2) {};
\end{pgfonlayer}
\node[anchor=south east,inner sep=5pt, fill = none] at (rect2.south east) {$M_{pm}$};

\begin{pgfonlayer}{background}
\node (rect) at (mu_nm_phot) [xshift = 30pt, yshift = -4pt, draw, rounded corners, thick, minimum width=110pt, 
minimum height=50pt, line width=1pt, fill=gray!20, fill opacity=0.5] (rect2) {};
\end{pgfonlayer}
\node[anchor=south east,inner sep=5pt, fill = none] at (rect2.south east) {$M_{ph}$};
...
\node[draw, circle, label={[name = pi_phot_lab,xshift=-10pt,yshift=3pt]below:$\pi_{CB}$}] (pi_phot) [below= of x_i, xshift=0pt,yshift=-0pt] {$[1]$};
